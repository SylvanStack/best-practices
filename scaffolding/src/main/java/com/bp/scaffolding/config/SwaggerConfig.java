...
public class SwaggerConfig {
    ...
    public Docket example() {
        return new Docket(DocumentationType.OAS_30)
                ...
                //特定包下的类，才生成接口文档
                .apis(RequestHandlerSelectors.basePackage("com.bp.scaffolding.api.restful"))
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
//                //特定包下的类，才生成接口文档
//                .apis(RequestHandlerSelectors.basePackage("com.bp.scaffolding.cms"))
//                .paths(PathSelectors.any())
//                .build()
...
//                .apis(RequestHandlerSelectors.withMethodAnnotation(ApiOperation.class))
//                //特定包下的类，才生成接口文档
//                .apis(RequestHandlerSelectors.basePackage("com.bp.scaffolding.api"))
//                .paths(PathSelectors.any())
//                .build()
